    ...
    <div class="coluna1">
        ...
        <div class="linha2">
            ...
            <div class="itens2">
                <table>
                    <?php
                        $consulta = FreaticoLencol::consultar($busca, $procurar);
                        foreach($consulta as $key => $line) {
                    ?>
                <tr>
                <th><a class="link" href="vermon.php?id_lencol=<?php echo $line['id_lencol']; ?>"><?php echo $line['id_lencol'];?></a></th>
                <td><?php echo date("d/m/Y", strtotime($line['data_analise']));?></td>
                <td><?php echo $line['num_amostra'];?></td>
                <td><a class="link" href="vermon.php?id_lencol=<?php echo $line['id_lencol']; ?>"><?php echo $line['relatorio_len'];?></td>
                <td><a  href="vermon.php?id_lencol=<?php echo $line['id_lencol']; ?>"><img src="../../img/icons/view.svg" alt="" style="height: 30px;"></a></td>
                <td><a class="table" href="cadmon.php?id_lencol=<?php echo $line['id_lencol'];?>&acao=update"><img src="../../img/icons/editar.svg" height="30px"></a></td>
                <td><a class="table" onclick="return confirm('Deseja mesmo excluir?')" href="../../php/controle/controle-freatico-lencol.php?id_lencol=<?php echo $line['id_lencol'];?>&acao=delete"><img src="../../img/icons/delete.svg" height="30px"></a></td>
            </tr>
            ...
            <?php
                if(isset($_GET['id_lencol'])){
                    $info = FreaticoLencol::consultarId($_GET['id_lencol'])[0];            
                        ...
                        echo "<p>Id do monitoramento: ".$info['id_lencol']."</p>";
                        echo "<p>Data do monitoramento: ".$info['data_analise']."</p>";
                        echo "<p>Número de amostra: ".$info['num_amostra']."</p>";
                        echo "<p>Relatório: ".$info['relatorio_len']."</p>";
                    }
                    ?>
        </div>
